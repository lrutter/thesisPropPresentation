...
\begin{frame}{Motivation - Visualizing genealogy}
  \begin{itemize}
		\item Agronomists at ISU wished to view soybean lineages on the fly
		\item Wanted to display paths between ancestors and descendants constrained by generation for a given variety
		\item Standard pedigree charts were not sufficient for certain genealogical lineages (especially ones related to agricultural breeding)
	\end{itemize}
\end{frame}
