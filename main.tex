...
\begin{figure}
    \centering
    \includemedia[width=0.9\textwidth, addresource=DRMovie.mov, deactivate=onclick, flashvars={source=animateGen.mov}]{\includegraphics{./DR_All2.png}}{VPlayer.swf}
    \caption{Animted version}
\end{figure}
\end{frame}
